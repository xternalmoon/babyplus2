...
export default function Header() {
  ...
  return (
    <>
      ...
      {/* Main Navigation */}
      <header className="bg-baby-green shadow-sm border-b border-gray-100 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              <Link 
                href="/" 
                className={`text-white hover:text-baby-accent font-medium transition-colors ${
            ...
            <div className="flex items-center space-x-4">
              {/* User Account */}
              <Link href="/profile">
                <Button variant="ghost" size="icon" className="text-white hover:text-baby-accent">
              ...
              <Button 
                variant="ghost" 
                size="icon"
                className="md:hidden text-white hover:text-baby-accent"
        ...
        {mobileMenuOpen && (
          <div className="md:hidden border-t border-green-400 bg-baby-green">
            <div className="px-4 py-3 space-y-3">
              <Link 
                href="/" 
                className="block text-white hover:text-baby-accent font-medium"
